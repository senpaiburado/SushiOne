...
//                Layout.column: 1
    ...
    function setDate(dateToSet) {
        calendar.currentDay = dateToSet.getDay();
        calendar.currentMonth = dateToSet.getMonth();
        calendar.currentYear = dateToSet.getFullYear();
        yearsList.positionViewAtIndex(calendar.currentYear - dateToSet.getFullYear(), ListView.SnapToItem);
        calendar.goToLastPickedDate();
    }
}
